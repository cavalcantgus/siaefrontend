<template>
  ...
  <h1 style="color: #57a340; margin-top: 10px; padding: 30px; font-size: 3rem">Pauta da Chamada</h1>
  <v-row justify="center" class="pr-2">
    <v-col cols="12">
      <v-data-table-virtual :items="filteredAgenda" :headers="headers" :search="search" single-expand v-model:expanded="expanded" :fixed-header="true" height="700px">
        <template v-slot:top>
