  ...
  <div class="pa-4 pr-12 pl-12">
    <v-form @submit.prevent="localOnSubmit" ref="formRef">
      <div class="grid-container">
        <v-select density="compact" name="products" :items="products" item-title="descricao" item-value="id" v-model="currentItem.produto.descricao" variant="outlined">
...
export default {
  ...
  computed: {
    isFormValid() {
      return !!(this.currentItem.produto.descricao && this.currentItem.quantidade);
    },
  },
  methods: {
    parseReal(val) {
